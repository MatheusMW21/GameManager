...
export default function WishlistPage() {
  ...
  const wishlist = games.filter((g) => g.status === 0);
        ...
        {wishlist.length === 0 ? (
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {wishlist.map((game) => (
              <Card
                key={game.id}
                className="bg-slate-900 border-slate-800 overflow-hidden group flex flex-col h-full hover:border-purple-500/50 transition-all shadow-md"
              >
                  ...
                  <div className="cursor-pointer h-full flex flex-col">
                    ...
                    <div className="p-3 flex-1 flex flex-col gap-2">
                      ...
                      <div className="text-xs text-slate-500 flex items-center gap-2">
                        <Star size={12} className="text-slate-600" /> Reviews no
                        detalhe
                      </div>
                    </div>
                  </div>
